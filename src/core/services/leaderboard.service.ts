...
} from '../primary-ports/shared.service.interface';
...
export class LeaderboardService implements ILeaderboardService {
  constructor(
    ...
    private highscoreRepository: Repository<HighscoreEntity>, // new
  ) {}
  ...
  async getHighScores(): Promise<HighscoreModel[]> {
    ...
    const modelHighscores: HighscoreModel[] = JSON.parse(
      JSON.stringify(highscoresDB),
    );
